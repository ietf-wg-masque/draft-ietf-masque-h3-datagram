...
HTTP/2 framing layer. When running over HTTP/1, only one request can exist on
an HTTP connection at a given time, therefore the first layer of demultiplexing
is not needed.
