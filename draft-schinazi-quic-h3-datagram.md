...
The flow identifier allocation services on both endpoints in a connection will
need to coordinate to agree on the meaning of each flow identifier. This will
require signalling, which is currently work in progress. This signalling
mechanism will also need a way to flow control the amount of flow identifiers
generated by a given endpoint.
